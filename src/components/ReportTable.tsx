...
interface ReportTableProps {
  yearlyData: ReportRow[];
  monthlyData: ReportRow[];
}
...
const ReportTable: React.FC<ReportTableProps> = ({ yearlyData, monthlyData }) => {
            ...
            <TableBody>
              {data.map((row) => (
                <TableRow key={row.label}>
                  ...
                  <TableCell>{formatCurrency(row.amountDeposited)}</TableCell>
