      ...
      <div className="mb-12 p-6 border rounded-xl bg-secondary/30">
        ...
        <div className="flex flex-col md:flex-row items-center justify-around text-center space-y-8 md:space-y-0">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-semibold text-base">Large Initial Corpus</p>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-semibold text-base">Fixed Periodic Withdrawal</p>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-semibold text-base">Remaining Corpus Grows</p>
